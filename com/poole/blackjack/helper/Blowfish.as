package com.poole.blackjack.helper
{
 ...
 {
	 [Embed(source="../../../../embed/key.bin",mimeType="application/octet-stream")]
	 private var keyEmbed:Class;
	 private var $key:String;
	 
	 public function Blowfish() {
		var bytes = new keyEmbed() as ByteArray;
 ...
 */
 public function decrypt($text:String):String
 {
 try
 {
